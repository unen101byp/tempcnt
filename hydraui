...
local CircleClick = function(Button)
    ...
    circle.Position = UDim2.new(0, game:GetService("Players").LocalPlayer:GetMouse().X - Button.AbsolutePosition.X, 0, game:GetService("Players").LocalPlayer:GetMouse().Y - Button.AbsolutePosition.Y);
